...
public class ReviewJdbcDao implements ReviewDao {
    ...
    // бо в БД rating NOT NULL, а в тесті його не задають
    ...
    public void add(Review review) {
        if (review == null) throw new IllegalArgumentException("review is null");
        if (review.getBook() == null) throw new IllegalArgumentException("review.book is null");
        if (review.getUser() == null) throw new IllegalArgumentException("review.user is null");

        // createdAt якщо null — хай буде зараз
        ...
        String sql = """
            INSERT INTO review (rating, comment, createdAt, book_id, user_id)
            VALUES (?, ?, ?, ?, ?)
        """;
    ...
    public void update(Review review) {
        if (review == null) throw new IllegalArgumentException("review is null");
        if (review.getId() == null) throw new IllegalArgumentException("review.id is null");
        if (review.getBook() == null) throw new IllegalArgumentException("review.book is null");
        if (review.getUser() == null) throw new IllegalArgumentException("review.user is null");
